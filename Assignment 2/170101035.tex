...
\begin{enumerate}[{\color{Magenta}A)}]
	...
	\pagebreak
	\textbf{Keep Alive} segments are also sent from the client to the server as explained in the previous quesion. These segments and also their acknowledgements can be seen from the screenshot attached.
	\begin{figure}[h]
		\includegraphics[width=\textwidth]{Images/pause2}
		\caption{Keep Alive Messages}
	\end{figure}
